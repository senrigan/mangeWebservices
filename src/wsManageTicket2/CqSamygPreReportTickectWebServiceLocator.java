...
public class CqSamygPreReportTickectWebServiceLocator extends org.apache.axis.client.Service implements wsManageTicket2.CqSamygPreReportTickectWebService {
    ...
    public wsManageTicket2.CqSamygPreReportTickectWebServicePortType getCqSamygPreReportTickectWebServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public wsManageTicket2.CqSamygPreReportTickectWebServicePortType getCqSamygPreReportTickectWebServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            wsManageTicket2.CqSamygPreReportTickectWebServiceBindingStub _stub = new wsManageTicket2.CqSamygPreReportTickectWebServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (wsManageTicket2.CqSamygPreReportTickectWebServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                wsManageTicket2.CqSamygPreReportTickectWebServiceBindingStub _stub = new wsManageTicket2.CqSamygPreReportTickectWebServiceBindingStub(new java.net.URL(CqSamygPreReportTickectWebServicePort_address), this);
                _stub.setPortName(getCqSamygPreReportTickectWebServicePortWSDDServiceName());
                return _stub;
            }
        }

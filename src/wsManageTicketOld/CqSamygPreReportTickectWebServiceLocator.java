...
public class CqSamygPreReportTickectWebServiceLocator extends org.apache.axis.client.Service implements wsManageTicketOld.CqSamygPreReportTickectWebService {
    ...
    public wsManageTicketOld.CqSamygPreReportTickectWebServicePortType getCqSamygPreReportTickectWebServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public wsManageTicketOld.CqSamygPreReportTickectWebServicePortType getCqSamygPreReportTickectWebServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            wsManageTicketOld.CqSamygPreReportTickectWebServiceBindingStub _stub = new wsManageTicketOld.CqSamygPreReportTickectWebServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (wsManageTicketOld.CqSamygPreReportTickectWebServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                wsManageTicketOld.CqSamygPreReportTickectWebServiceBindingStub _stub = new wsManageTicketOld.CqSamygPreReportTickectWebServiceBindingStub(new java.net.URL(CqSamygPreReportTickectWebServicePort_address), this);
                _stub.setPortName(getCqSamygPreReportTickectWebServicePortWSDDServiceName());
                return _stub;
            }
        }
